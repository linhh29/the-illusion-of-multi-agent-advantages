import random
import re
from utils import generate_answer, extract_math_answer
from prompt_lib import ROLE_MAP, construct_ranking_message, construct_message, SYSTEM_PROMPT_BCP


class LLMNeuron:
    
    def __init__(self, role, mtype="gpt-4o", ans_parser=extract_math_answer, qtype="single_choice"):
        self.role = role
        self.mtype = mtype
        self.qtype = qtype
