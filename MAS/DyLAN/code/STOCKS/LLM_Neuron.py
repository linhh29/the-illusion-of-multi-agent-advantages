# -*- coding: utf-8 -*-
"""LLM Neuron for STOCKS: uses raw reply as answer (no single-choice parsing)."""
import random
import re
from utils import parse_stocks_raw, generate_answer
from prompt_lib import ROLE_MAP, construct_ranking_message, construct_message, SYSTEM_PROMPT_STOCKS


class LLMNeuron:
    def __init__(self, role, mtype="gpt-4o", ans_parser=parse_stocks_raw, qtype="stocks"):
        self.role = role
        self.mtype = mtype
        self.qtype = qtype
