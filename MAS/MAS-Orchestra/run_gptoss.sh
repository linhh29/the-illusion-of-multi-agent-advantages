...
# Same baseline seconds as gpt-4o OpenAI timeout; sampler applies 3× for gpt-oss (effective default 1800s unless overridden by env).
export MAS_TOGETHER_CHAT_TIMEOUT_SEC="${MAS_TOGETHER_CHAT_TIMEOUT_SEC:-600}"
