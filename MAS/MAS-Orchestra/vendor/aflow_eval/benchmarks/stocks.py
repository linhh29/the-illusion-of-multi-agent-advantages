...
class StocksBenchmark(BaseBenchmark):
    """
    Benchmark for the synthetic stocks dataset.

    Expected reference format (per line in the jsonl file, consistent with
    `stocks_synthetic_dataset/evaluate/README.md`):
    ...
    def __init__(self, name: str, file_path: str, log_path: str):
        ...
        # tmp/mas_eval/stocks_synthetic_dataset/evaluate/safe_code_executor.py
    ...
    def _parse_model_output(self, raw_output: Any) -> Tuple[str, str, str]:
        ...
        if isinstance(obj, dict):
            # optional wrapper: "output" or "response" (STOCKS workflow returns {"response": json_string})
    ...
    def _evaluate_direct_answer(
        ...
        """
        Replicates the logic from evaluate_stock_answer_code.evaluate_direct_answer.
        """
    ...
    def _evaluate_code_output(
        ...
        tmp/mas_eval/stocks_synthetic_dataset/evaluate/evaluate_stock_answer_code.py,
