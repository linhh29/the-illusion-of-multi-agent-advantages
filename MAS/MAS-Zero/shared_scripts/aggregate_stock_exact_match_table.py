...
def main():
    ...
    parser.add_argument("result_dirs", nargs="+", help="Stock result directories.")
    parser.add_argument(
        "--dataset-path",
    ...
    parser.add_argument(
        "--csv-output",
        default="outputs/stock_exact_match_by_depth.csv",
    )
    parser.add_argument(
        "--md-output",
        default="outputs/stock_exact_match_by_depth.md",
    )
