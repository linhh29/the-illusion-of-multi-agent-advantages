...
def load_evaluator(evaluator_path: Path):
    ...
    spec = importlib.util.spec_from_file_location("stock_answer_evaluator", evaluator_path)
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Convert old stock *_plan_response files and optionally evaluate them by depth."
    )
    parser.add_argument(
        "--root",
        default="outputs",
    ...
    parser.add_argument(
        "--dataset",
        default="workflow_search/stock",
        help="Dataset path fragment under outputs. Default: workflow_search/stock",
    )
    parser.add_argument(
        "--output",
        default=None,
        help="Output JSONL path for evaluate_stock_answer_code.py --model-output",
    )
    parser.add_argument(
        "--model",
        default=None,
    ...
    parser.add_argument(
        "--evaluator",
        default="stocks_synthetic_dataset/evaluate/evaluate_stock_answer_code.py",
        help="Path to evaluate_stock_answer_code.py.",
    )
    parser.add_argument(
        "--timeout",
        type=int,
