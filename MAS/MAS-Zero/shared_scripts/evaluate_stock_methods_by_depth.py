...
def load_evaluator(path: Path):
    ...
    spec = importlib.util.spec_from_file_location("stock_eval", path)
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Evaluate stock methods by depth from old *_plan_response files.")
    parser.add_argument("--root", default="outputs")
    parser.add_argument("--dataset", default="workflow_search/stock")
    parser.add_argument("--model", default=None)
    parser.add_argument("--reference", required=True)
    parser.add_argument("--evaluator", default="stocks_synthetic_dataset/evaluate/evaluate_stock_answer_code.py")
