...
from maas.ext.maas.benchmark.stock import StockBenchmark

DatasetType = Literal["HumanEval", "GSM8K", "MATH", "GPQA", "HLEMATH", "BCP", "SWE", "Stock"]
...
class Evaluator:
    ...
    async def graph_evaluate(
        ...
        if dataset == "Stock" and "eval_mode" in params:
