...
from benchmarks.swe import SWEBenchmark
...
class Evaluator:
    ...
    async def graph_evaluate(
        ...
        data_path = self._get_data_path(dataset, is_test, dataset_config)
    ...
    def _get_data_path(self, dataset: DatasetType, test: bool, dataset_config: dict) -> str:
