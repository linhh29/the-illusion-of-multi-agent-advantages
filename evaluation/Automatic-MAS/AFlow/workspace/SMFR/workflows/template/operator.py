...
from workspace.SMFR.workflows.template.operator_an import *
from workspace.SMFR.workflows.template.op_prompt import *
...
class ScEnsemble(Operator):
    """
    For SMFR: LLM synthesizes best answer in same format (analysis, answer, code).
