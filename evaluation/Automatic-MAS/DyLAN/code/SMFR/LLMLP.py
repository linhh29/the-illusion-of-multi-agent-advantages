# -*- coding: utf-8 -*-
"""LLMLP for SMFR: qtype smfr, raw reply as answer (no early consensus)."""
import math
import random
from LLM_Neuron import LLMNeuron, LLMEdge, listwise_ranker_2
from utils import parse_smfr_raw, most_frequent
...
class LLMLP:
    def __init__(self, default_model_name, agents=4, agent_roles=None,
                 rounds=2, activation="listwise", qtype="smfr", mtype="gpt-4o"):
        ...
        self.qtype = qtype
        # For smfr we never consider two raw replies equal -> no early consensus
        self.cmp_res = lambda x, y: False
        self.ans_parser = parse_smfr_raw
