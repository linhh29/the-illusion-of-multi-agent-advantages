import random
import re
from utils import extract_patch, generate_answer
from prompt_lib import ROLE_MAP, construct_ranking_message, construct_message, SYSTEM_PROMPT_SWE


class LLMNeuron:
    
    def __init__(self, role, mtype="gpt-4o", ans_parser=extract_patch, qtype="code_patch"):
        self.role = role
        self.mtype = mtype
        self.qtype = qtype
