...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default="2,3,4,5,6",
        help="Comma-separated complexity levels to test for Smfr dataset (default: 2,3,4,5,6).",
    )
...
if __name__ == "__main__":
    ...
    if config.dataset == "Smfr":
        optimizer.smfr_levels = [int(x) for x in args.smfr_levels.split(",")]
