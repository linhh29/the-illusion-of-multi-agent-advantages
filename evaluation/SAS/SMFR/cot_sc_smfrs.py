...
def get_cot_sc_ensemble_size(base_dir_name):
    """Infer ensemble size from prior run logs (avg API calls per question). Default 5."""
...
async def main():
    ...
    # Ensemble size: optional argv[8] overrides (after CODE_EVAL_MODE); else use default ensemble size of 5
